...
public class EmployeeTest {
    ...
    public static void main(String[] args) {
        ...
        employees.sort(Comparator.comparing(Employee::getSocialSecurityNumber));

        System.out.printf("%-12s %-11s %-14s %-15s %-7s %-14s %-10s %-14s %-12s%n", "First Name", "Last Name", "Social Sec #", "Weekly Salary", "Wage", 
        "Hours worked", "Com rate", "Gross salary", "Base Salary");
